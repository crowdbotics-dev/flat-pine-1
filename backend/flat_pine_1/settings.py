"""
Django settings for flat_pine_1 project.
...
WSGI_APPLICATION = 'flat_pine_1.wsgi.application'
...
SPECTACULAR_SETTINGS = {
    ...
    "TITLE": "flat_pine_1 API",
    "DESCRIPTION": "API documentation for flat_pine_1 App",
    "VERSION": "v1",
}
